...
function TablePage({ onClose }: any) {
  return (
    <div className="flex flex-col items-center justify-center py-2 px-2 bg-gradient-to-l from-indigo-500 from-10% via-sky-500 via-30% to-emerald-500 to-90%">
      <div className="flex flex-col w-full p-8 space-y-4 items-center bg-white rounded-lg shadow-md mx-auto">
        ...
        <button className="text-white bg-blue-700 hover:bg-blue-800 focus:outline-none font-medium text-2xl self-center mb-4 rounded-lg px-6 py-3 text-center mr-5 hover:scale-110 ease-in duration-300" onClick={onClose}>
          EXIT
        </button>
      </div>
    </div>
